...
{	document.getElementById("errorRut").innerHTML="";
	...
	if ( largo < 2 )	
	{		
		document.getElementById("errorRut").innerHTML="Debe ingresar el R.U.T completo";			
		return false;	
	}	
	if ( largo > 2 )		
	...
	{		
		document.getElementById("errorRut").innerHTML="EL R.U.T ingresado es incorrecto";			
		return false	
	}
	return true
}
...
function Rut()
{
	var texto = document.getElementById("rut").value;
	var tmpstr = "";	
